...
def build(quiet=False):
    ...
    site = {
        ...
        "defaultScoreMode": cfg.get("defaultScoreMode", "level"),
        "scoreWindow": cfg.get("scoreWindow", 20),
        "scoreCurve": cfg.get("scoreCurve", "tanh"),
        "scoreCurveK": cfg.get("scoreCurveK", 2.5),
